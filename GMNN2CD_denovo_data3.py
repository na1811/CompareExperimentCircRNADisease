...
def normalized(wmat):
    ...
    # Thay thế các giá trị là vô cùng (inf) hoặc NaN bằng 0
    degpow = np.where(np.isinf(degpow) | np.isnan(degpow), 0, degpow)
...
if __name__=="__main__":
    ...
    result
    np.savetxt("./denovo_prediction_output/Dataset3/GMNN2CD_result_data3.csv", result, delimiter=",")
